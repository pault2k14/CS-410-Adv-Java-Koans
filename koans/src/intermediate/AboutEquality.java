...
public class AboutEquality {
    ...
    static class Car {
        ...
        public int hashCode() {
            ...
            hashInt += this.horsepower/7;

            for(Character character : this.name.toCharArray()) {
                hashInt += character/7;
            }
            return hashInt;
        }
    ...
    static class Chicken {
        ...
        public int hashCode() {
            ...
            for(Character character: this.color.toCharArray()) {
                hashInt += character/7;
            }
        ...
        public boolean equals(Object other) {
            if (!(other instanceof Chicken))
                return false;
            return ((Chicken) other).color.equals(this.color);
        }
    }
